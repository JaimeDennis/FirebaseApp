...
import com.example.firebaseapp.Contacts
import com.example.firebaseapp.FirebaseReferences
...
class ListActivity : AppCompatActivity() {
    ...
    private lateinit var listViewContactos: ListView // Obtén una referencia a tu ListView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listViewContactos = findViewById(R.id.listViewContactos) // Asocia el ListView con el XML
        obtenerContactos()
        ...
        val listener = object : ChildEventListener {
            override fun onChildAdded(dataSnapshot: DataSnapshot, s: String?) {
                ...
                contacto?.let {
                    ...
                    listViewContactos.adapter = adapter // Establece el adaptador en el ListView
                }
            }
    ...
    private fun mostrarDialogoConfirmacion(contacto: Contacts, position: Int) {
        ...
        builder.setPositiveButton("Sí") { dialog, _ ->
            ...
            (listViewContactos.adapter as? MyArrayAdapter)?.remove(contacto) // Elimina el contacto del adaptador
